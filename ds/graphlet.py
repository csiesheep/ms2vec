        ...
        while i < len(nodes):
            ...
            if i == 4:
                ...
                for from_id in nodes:
                    tmp_id2count[from_id] = id2count[from_id] * 17
                    for to_id in nodes:
                        if from_id == to_id:
                            continue
                        if to_id in graph.graph[from_id]:
                            tmp_id2count[from_id] += id2count[to_id]
                id2count = tmp_id2count
...
class GraphletMatcher():
    ...
    def __init__(self):
        self.template = { #{(degrees): (roles)}
            ...
            (2, 2, 3, 3): (0, 0, 1, 1),
            (3, 3, 3, 3): (0, 0, 0, 0),
            (19, 19, 37, 37, 38): (0,0,1,1,2),
            (38, 38, 38, 38, 38): (0,0,0,0,0),
            (19, 20, 20, 38, 55): (0,1,1,2,3),
            (19, 38, 39, 39, 57): (0,1,2,2,3),
            (20, 38, 39, 39, 56): (0,1,2,2,3),
            (20, 20, 40, 57, 57): (0,0,1,2,2),
            (40, 40, 57, 57, 57): (0,0,1,1,1),
            (39, 39, 40, 58, 58): (0,0,1,2,2),
            (20, 40, 58, 59, 59): (0,1,2,3,3),
            (40, 59, 59, 60, 60): (0,1,1,2,2),
            (21, 21, 21, 21, 72): (0,0,0,0,1),
            (21, 21, 40, 40, 74): (0,0,1,1,2),
            (40, 40, 40, 40, 76): (0,0,0,0,1),
            (21, 41, 41, 59, 76): (0,1,1,2,3),
            (41, 41, 60, 60, 78): (0,0,1,1,2),
            (21, 61, 61, 61, 78): (0,1,1,1,2),
            (61, 61, 61, 61, 80): (0,0,0,0,1),
            (42, 42, 42, 78, 78): (0,0,0,1,1),
            (42, 62, 62, 80, 80): (0,1,1,2,2),
            (63, 63, 82, 82, 82): (0,0,1,1,1),
